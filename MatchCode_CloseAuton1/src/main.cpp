...
void autonomous(void) {
  mind('w',2,-3.25); //drive to middle
  mind('a',.75,-1);  //turn, intake to goal

  intake.spinFor(reverse,3,sec);  //output triball

  mind('w',2,-3.25); //drive away from triball
  mind('a',.75,2);  //turn, intake to center

  flaps.set(true);  //open flaps

  mind('w',1,-4);  //push triballs in goal
}
